# coding: utf8
""" Implementation of the meta-class :class:`AbstractBetaEnsemble` see :math:`\\beta-`:ref:`Ensembles<beta_ensembles>` with children:

- :class:`HermiteBetaEnsemble`
- :class:`LaguerreBetaEnsemble`
- :class:`JacobiBetaEnsemble`
- :class:`CircularBetaEnsemble`
