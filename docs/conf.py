...
latex_documents = [
    (master_doc, "main.tex", "DPPy documentation", "Guillaume Gautier et al.", "report")
]
...
def setup(app):
    app.add_css_file("custom.css")  # remove line numbers
...
man_pages = [(master_doc, "dppy", "DPPy Documentation", [author], 1)]
