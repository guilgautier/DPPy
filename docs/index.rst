...
If you start by Section :ref:`dppy_objects`, you will find a more traditional library documentation, documenting the methods in each class, along with pointers to the mathematical definitions if needed. 
