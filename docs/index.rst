...
If you start by the API references sections, you will find a more traditional library documentation, documenting the methods in each class, along with pointers to the mathematical definitions if needed. 
Third, you can also directly jump to the Jupyter `notebooks <https://github.com/guilgautier/DPPy/tree/master/notebooks>`_, which showcase the use of a few DPPy objects in more detail.
